...
function createWindow() {
  ...
  mainWindow.webContents.once('did-start-loading', () => {
    // 이미 show:false → ready-to-show에서 처리
  })
  ...
  const template = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: wordWrap ? '줄 바꿈 끄기 ✓' : '줄 바꿈 켜기', accelerator: 'Alt+Z', click: () => win.webContents.send('menu:toggle-wordwrap') },
        { type: 'separator' },
